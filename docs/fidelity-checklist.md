...
would also require the copyrighted ROM image to be present. This project
reimplements the logic instead and uses ROM data only for what cannot be
derived from documentation: artwork, colour and sound waveforms.
